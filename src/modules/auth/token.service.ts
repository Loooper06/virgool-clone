...
export class TokenService {
  ...
  genOtpToken(payload: CookiePayload) {
  ...
  genAccessToken(payload: AccessTokenPayload) {
    const token = this.jwtService.sign(payload, {
  ...
  genEmailToken(payload: EmailTokenPayload) {
    const token = this.jwtService.sign(payload, {
  ...
  genPhoneToken(payload: PhoneTokenPayload) {
    const token = this.jwtService.sign(payload, {
